  ...
  <div id="supernav" class="track_me_TopNavigation_Click" >
    <div id="superzone">
      ...
      <?php if (IS_INDEX) {
        ...
        <div class="text hours tour_1" style="margin-right: 50px;"><a href="<?php print PATH_FROM_ROOT; ?>/hours/" title="Click to see more hours">Richter hours:<br /><?php print $today; ?></a></div>
      <?php } ?>
